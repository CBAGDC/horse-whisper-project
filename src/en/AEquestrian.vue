...
export default {
 ...
 setup() {
   ...
   const fetchArticleData = async (articleId = '17') => {
     try {
       const response = await axios.get('http://cwebcrm.cn:8046/api/v1/notices/article-list?classid=7');
   ...
   const handleTranslateClick = () => {
     router.push({ name: 'zAEquestrian' }); // 跳转到 zn 的 zAHone 页面
   };
